function [ filterImage, imgFilterSteps ] = scallopFilter( workImage )
...
[filterImage, imgFilterSteps] = bwFilter( dilateImage, filterParams );
...
function [filterImage, imgFilterSteps] = bwFilter(img, regionFilterParams)
