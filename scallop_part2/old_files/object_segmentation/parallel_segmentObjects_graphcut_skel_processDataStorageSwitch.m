function [ visualAttnOutData ] ...
    = parallel_segmentObjects_graphcut_skel_processDataStorageSwitch( visualAttnInData, fixationWindowSize, numSegments, varargin )
...
function reducedCircleList = filterCircles( circList, fixationWindowSize )
...
%% Circle Radius Filter and Center Limits
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
