function [ visualAttnOutData ] ...
    = parallel_segmentObjects_graphcut_skel( visualAttnInData, fixationWindowSize, numSegments )
...
parfor imageI = 1:numImages
    ...
    for fixationI = 1:fixationsVar(imageI)        
        ...
        [origCircList, imgFilterSteps] = detectPrattCircle_graph( fixationWindow, filterImage, labelImage, imgFilterSteps ); 
