function [ classData, params ] = classifierStats_testing( params, statData, distributionData, segmentData, fixationData )
...
classificationResults.skippedScallopsDetected = sum( scallopDistrMatchCounts <= scallopVerdictThreshold );
classificationResults.skippedScallopsMissed = sum( nonScallopDistrMatchCounts > scallopVerdictThreshold );
...
fixationResults = computeWindowLength( fixationResults, ...
    min( params.fixationWindowSize(:))/2, sum( [statData.groundTruth.numScallops] ) ); 
...
finalResults = [];
% finalResults.totalImages = totalImages;
% finalResults.numGroundTruthScallops = numGroundTruthScallops;
% finalResults.numSegmentObjects = numSegmentObjects;
% finalResults.numBGObjects = numBGObjects;
% 
% finalResults.numScallopsAfterVisual = numScallopsAfterVisual;
% finalResults.percentScallopsAfterVisual = percentScallopsAfterVisual;
% 
% finalResults.numScallopsAfterSegment = numScallopsAfterSegment;
% finalResults.percentScallopsAfterSegment = percentScallopsAfterSegment;
% 
% finalResults.numScallopsAfterClassifier = numScallopsAfterClassifier;
% finalResults.percentScallopsAfterClassifier = percentScallopsAfterClassifier;
% 
% finalResults.numNonScallopsAfterClassifier = numNonScallopsAfterClassifier;
% finalResults.percentNonScallopsAfterClassifier = percentNonScallopsAfterClassifier;
