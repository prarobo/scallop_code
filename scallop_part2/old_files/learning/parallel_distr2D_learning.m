function [ distributionData, scallopInfo, params ] = parallel_distr2D_learning( params, fileInfo, groundTruth )
...
parfor imageI=1:numImages    
    if groundTruth(imageI).numScallops ~= 0
        ...
        dataPoint{imageI} = parallelImageProcessing( groundTruth(imageI), currFilename, params, imageI, cform);
    end
end
...
function [ currDataPointCum ] = parallelImageProcessing( currGroundTruth, currFilename, params, imageI, cform )
...
currSample = computeFeatureMaps( currImage, params, cform );
...
for scallopI = 1:numScallops
    ...
    for f=1:numFeatures
        ...
        currDataPoint.(featureFeature) = bin2DScallop_median(currSample.(featureMap),...
            centerX,...
            centerY,...
            radius,...
            [params.numRadBins ...
...
function currSample = computeFeatureMaps(currImage, params, cform)
