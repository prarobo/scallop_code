...
for quadrantI = 1:numQuadrants
    if quadrantIDTemp(quadrantI).num ~= 0
        ...
        if quadrantIDTemp(quadrantI).num ~= 1
            quadrantIDTemp(quadrantI).stddevScallop = sqrt(quadrantIDTemp(quadrantI).num/(quadrantIDTemp(quadrantI).num-1)) *...
                sqrt( (quadrantIDTemp(quadrantI).X2./quadrantIDTemp(quadrantI).num)...
                -quadrantIDTemp(quadrantI).meanScallop.^2 );
        else
            quadrantIDTemp(quadrantI).stddevScallop = zeros(1,numBins);
        end
    else
