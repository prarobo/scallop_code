function [ scallopTestingOutData ] = readGroundTruth( scallopTestingInData, statFile )
...
scallopTestingOutData.statData.groundTruth(scallopTestingOutData.params.numImages) = struct;

for imageI = 1:scallopTestingOutData.params.numImages
