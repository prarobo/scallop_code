function [ classData, detectionStats, params ] ...
    = classifierStats_testing_boundary( params, statData, distributionData, groundTruth, segmentData, fixationData )
...
scallopVerdictThreshold = 7; %5.5; %5.7; %4.1;
numGroundTruthScallops = sum( [groundTruth.numScallops]);
numGroundTruthBoundaryScallops = sum( [groundTruth.numBoundaryScallops]);
...
fixationResults = computeFixationResults( params, fixationData, groundTruth );
