function [ distributionData, params] ...
    = parallel_distr2D_testing_linear_metadata( params, ...
                                                  fileInfo, ...
                                                  fixationData, ...
                                                  segmentData, ...
                                                  confIntervalData, ...
...
%     end
    ...
    for imageI=1:numImages
        ...
        currImageWidth = params.imageSize(2);
        currObjList = objList{imageI};
...
numImages = params.numImages;
currImage = imresize( imread( currFilename ), params.resizeFactor);
...
for imageI=1:numImages
    ...
    filterObjList = filterCircles( currObjList, params.imageSize, params );
