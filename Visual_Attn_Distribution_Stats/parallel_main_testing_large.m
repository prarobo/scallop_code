...
if( ~any( strcmp( fieldnames(scallopTesting), 'fileInfo' ) ) )
    ...
    numStartImage = 1;
    numSubsetImages = 1299;    %1299;
    scallopTesting = readImages_distr_metadata(imageFolder, imageMetaDataFile, scallopTesting, numStartImage, numSubsetImages);
...
[scallopTesting.statData.detectionStats, scallopTesting.statData.categoryStats, scallopTesting.params] ...
    = detectionStats_testing_scallopid( scallopTesting.params, scallopTesting.statData.groundTruth, scallopTesting.distributionData);
save( scallopTestingFile, 'scallopTesting' );
...
if( ~any( strcmp( fieldnames(scallopTesting), 'classData' ) ) )    
    ...
    [scallopTesting.classData, scallopTesting.statData.detectionStats, scallopTesting.params] ...
        = classifierStats_testing_setclassscallop( scallopTesting.params, ...
...
%% Save Timer Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
timeStr.program = toc(programTime);
