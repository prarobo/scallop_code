function [ visualAttnOutData ] ...
    = parallel_segmentObjects_graphcut_filter( visualAttnInData, fixationWindowSize, numSegments )
...
parfor imageI = 1:numImages
    ...
    for fixationI = 1:fixationsVar(imageI)        
        ...
        filterCircList = filterCircles( origCircList );
        [finalCircList, imgFilterSteps] = filterCirclesGraph( filterCircList, graphImage, labelImage, filterImage, params );
