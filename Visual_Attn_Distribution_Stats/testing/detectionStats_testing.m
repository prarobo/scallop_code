function [ detectionStats, categoryStats, params ] = detectionStats_testing( params, groundTruth, distributionData )
...
for imageI=1:numImages
    ...
    for scallopI=1:numScallops
        ...
        detectionStats(imageI).scallop{scallopI}.scallopID = 0;
