function [ visualAttnOutData ] = parallel_distr_2D_compute_writeCSV_noadjust( visualAttnInData, scallopDistribution, discretOn, checkOn, writeOn )
...
if writeOn
    for imageI=1:numImages
        writeAttrCSV( params, fixationsVar, dataPoint{imageI}, imageI, numImages);
    end
    %     matlabpool close
end
