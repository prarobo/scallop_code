function [visualAttnOutData] = readImages_distr( imgFolder, visualAttnInData, varargin )
...
visualAttnOutData.params.numImages = numImages;
visualAttnOutData.fileInfo.filename = cell(numImages,1);
visualAttnOutData.fileInfo.foldername = imgFolder;

for i=numStartImage:numStartImage+numImages-1
    visualAttnOutData.fileInfo.filename{i} = f_images(i).name;
end
...
visualAttnOutData.params.imageSize = size(origImage);
