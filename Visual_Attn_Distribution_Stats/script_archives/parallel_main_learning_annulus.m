...
addpath( genpath('./Visual_Attn_Distribution_Stats') );
...
if( ~any( strcmp( fieldnames(scallopDistr), 'distributionData' ) ) )
    ...
    scallopDistr.params.adjustOn = true;

    [scallopDistr.distributionData, scallopDistr.scallopInfo, scallopDistr.params] ...
        = parallel_distr2D_learning_annulus( scallopDistr.params, scallopDistr.fileInfo, scallopDistr.groundTruth );
    save( learnDistributionFile, 'scallopDistr' );  
else
