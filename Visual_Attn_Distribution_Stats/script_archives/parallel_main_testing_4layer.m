...
if( ~any( strcmp( fieldnames(scallopTesting), 'distributionData' ) ) )
    ...
    [scallopTesting.distributionData, scallopTesting.params] ...
        =  parallel_distr2D_testing_boundary_restoreSwitch( scallopTesting.params, ...
        scallopTesting.fileInfo, ...
...
%% Loading Scallop Confidence Interval Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if ext==0
    ...
    % preComputed=1;
    fprintf('Precomputed scallop lookup found\n');
    if( ~any( strcmp( fieldnames(scallopTesting), 'layer4Data' ) ) )
        fprintf('Loading scallop lookup table ...');
        load(lookupFile);
        confIntervalData = scallopLookup.confIntervalData;
        scallopLookupParams = scallopLookup.params;
...
scallopTesting.params.scallopVerdictThreshold = 7; %5.5; %5.7; %4.1;
scallopTesting.params.matchMetric = 'matchTemplateVal';
scallopTesting.params.metricType = 'lesserTheBetter'; % 'greaterTheBetter'
scallopTesting.params.storeLayer4Data = false;
% scallopTesting.params.layer4ThresholdBrightObjFillSize = 0.2;

fprintf('Computing layer4...\n');
[scallopTesting.layer4Data, scallopTesting.params] ...
    = layer4_testing( scallopTesting.params, scallopTesting.fileInfo, ...
                        scallopTesting.statData, scallopTesting.distributionData, ...
                        confIntervalData, scallopLookupParams );
                    
save( scallopTestingFile, 'scallopTesting' );

else
    fprintf('I have it! Layer4 information\n');
end
...
if( ~any( strcmp( fieldnames(scallopTesting), 'classData' ) ) )    
    ...
    [scallopTesting.classData, scallopTesting.statData.detectionStats, scallopTesting.params] ...
        = classifierStats_testing_boundary_4layer( scallopTesting.params, ...
        scallopTesting.statData, ...
        scallopTesting.distributionData, ...
        scallopTesting.segmentData, ...
        scallopTesting.fixationData, ...
        scallopTesting.layer4Data );
