...
learnScallopLookupFile = 'scallopLookupTable.mat';
testingAttrFile = 'attrData_testing.csv';
...
if ~exist('scallopDistr', 'var')
    ...
    [scallopDistr.groundTruth, scallopDistr.radiusData] ...
        = readGroundTruth_learning_metadata(scallopDistr.params, scallopDistr.fileInfo, groundTruthFile);
...
%% Generating Look Up Table of Scallop Statistics
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

funcTime = tic;

scallopDistr.params.confIntervalScallop = 0.5;
scallopDistr.params.confIntervalHalfWindow = [20 20];

fprintf('Computing lookup table ...\n');
scallopLookup = createScallopLookupTable( scallopDistr.params );

fprintf('Computing confidence interval ...\n');
scallopLookup.confIntervalData = lookup_confInterval_learning( scallopDistr.params, scallopLookup );

save( learnScallopLookupFile, 'scallopLookup');

timeStr.lookup = toc(funcTime);
