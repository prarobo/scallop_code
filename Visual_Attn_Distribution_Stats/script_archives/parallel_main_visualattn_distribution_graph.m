...
visualAttnData = parallel_applyWeightsFixations_distr( visualAttnData, numFixations, saliencyMapsFile );
save(visualAttnFile, 'visualAttnData');
...
visualAttnData = parallel_segmentObjects_graphcut_filter( visualAttnData, fixationWindowSize, numSegments, clearGraphBorders );
save( visualAttnFile, 'visualAttnData' );
else
...
discretOn = true;
checkOn = true;
visualAttnData = parallel_distr_2D_compute_graph(visualAttnData, scallopDistribution, discretOn, checkOn);
save( visualAttnFile, 'visualAttnData' );
...
visualAttnData = detectionStats_filtered_graph( visualAttnData );
save( visualAttnFile, 'visualAttnData' );
...
visualAttnData = classifierStats_graph( visualAttnData );
save( visualAttnFile, 'visualAttnData' );
...
% 
% displayWindowLengths( visualAttnData );

displaySegmentationEdgeGraphComparison( visualAttnData );
