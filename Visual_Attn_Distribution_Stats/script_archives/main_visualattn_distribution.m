...
visualAttnFile = sprintf('visualAttnData_discret_5_20_wts_1_1.mat');
...
distributionFile = sprintf('/home/prasanna/Linux_Workspaces/Matlab_linux_new/Scallop Stats/results_archives/scallopGaussianProcess_5_20_discret.mat');
...
visualAttnData = applyWeightsFixations_distr( visualAttnData, saliencyMapsFile );
save(visualAttnFile, 'visualAttnData');
...
visualAttnData.params.fixationWindowSize = [200 200];
visualAttnData = segmentObjects( visualAttnData );
save( visualAttnFile, 'visualAttnData' );
else
...
confInterval = 0.95;
visualAttnData = distr_2D_confInterval(visualAttnData, scallopDistribution, confInterval);

fprintf('Computing current data distribution ...\n');
visualAttnData = distr_2D_compute(visualAttnData, scallopDistribution);
save( visualAttnFile, 'visualAttnData' );
...
visualAttnData = detectionStats( visualAttnData );
save( visualAttnFile, 'visualAttnData' );
